  ...
  return (
    <div className="relative w-full min-h-[calc(100vh-5rem)] flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[10%] right-[15%] w-[500px] h-[500px] bg-[#3b82f6]/10 rounded-full blur-[120px] animate-pulse" />
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          ...
          <div className="group relative p-8 bg-white/40 backdrop-blur-2xl rounded-[2.5rem] border border-white/60 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-300 flex flex-col items-center gap-5">
            <div className="p-4 bg-blue-50 text-[#3b82f6] rounded-2xl shadow-inner group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="flex flex-col items-center gap-6 py-10">
          ...
          <a
            ...
            className="group relative flex items-center gap-4 px-8 py-4 bg-gray-900 text-white rounded-[2rem] hover:bg-black transition-all shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4)] active:scale-95 overflow-hidden opacity-50 cursor-not-allowed"
          >
        ...
        <div className="pt-4">
          <Link href={"/home"}>
            <button className="inline-flex items-center gap-3 px-6 py-2 text-gray-400 hover:text-[#3b82f6] transition-all font-bold group cursor-pointer rounded-full hover:bg-blue-50/50">
              <ArrowLeft
                size={20}
