export const TRANSLATIONS = {
  zh: {
    ...
    questionPage: {
      title: '八股文库',
      description: '管理及复习你的八股文知识点。',
      searchPlaceholder: '搜索知识点...',
      filterBtn: '筛选',
      createBtn: '创建',
      // 筛选弹窗内容
      filterModalTitle: '筛选知识点',
      filterModalDes: '通过难度、状态或标签精细化你的知识点列表。',
      filterLabelDiff: '难度',
      ...
      deleteModalDes:
        '此操作无法撤销。这将永久移除该知识点的复习进度、笔记和答案内容。',
      deleteBtn: '删除',
      deletingBtn: '删除中...',
      cancelBtn: '取消',
    },
    platformSelector: {
      newQuestion: '新增知识点',
      chooseOption: '选择你想如何新增知识点',
      leetCode: '计算机基础',
      autoFill: '通过 URL 自动填充',
      custom: '自定义',
      customFill: '手动填充',
      pasteLink: '粘贴链接',
      autoFillDesc: '暂不支持自动填充，请使用自定义方式',
      back: '返回',
      fetching: '获取中...',
      next: '下一步',
      cancel: '取消',
    ...
    reviewHeader: {
      title: '每日复习',
      descriptionWithCount: '你今天有 {{count}} 个知识点需要复习。',
