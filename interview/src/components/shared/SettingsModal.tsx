      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2.5">
            ...
            >
              <SelectTrigger className="w-full h-[46px]! px-5 bg-white border border-gray-200/60 rounded-2xl shadow-sm hover:border-[#3b82f6]/50 focus:ring-2 focus:ring-[#3b82f6]/20 transition-all outline-none font-medium text-gray-800">
                <SelectValue />
              </SelectTrigger>
              <SelectContent className="rounded-2xl border-gray-100 shadow-xl bg-white/90 backdrop-blur-xl">
                {LANGUAGES.map((lang) => (
                  <SelectItem
                    key={lang.label}
                    value={lang.value}
                    className="cursor-pointer py-3 rounded-xl focus:bg-blue-50 focus:text-[#3b82f6] font-medium"
                  >
                    {lang.label}
                  </SelectItem>
                ))}
          ...
          <div className="space-y-2.5">
            ...
            <div className="relative">
              <Input
                ...
                className="w-full h-[46px] px-5 bg-white border border-gray-200/60 rounded-2xl shadow-sm hover:border-[#3b82f6]/50 focus-visible:ring-2 focus-visible:ring-[#3b82f6]/20 transition-all outline-none font-medium text-gray-800 pr-16"
              />
