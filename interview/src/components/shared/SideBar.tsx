                  ...
                  return (
                    ...
                    >
                      {isActive && (
                        <motion.div
                          layoutId="active-bg"
                          className="absolute inset-0 bg-linear-to-r from-blue-50 to-transparent opacity-100"
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                          exit={{ opacity: 0 }}
                        />
                      ...
                      {isActive && (
                        <motion.div
                          ...
                          className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 bg-[#3b82f6] rounded-r-full shadow-[0_0_10px_#3b82f6]"
                        />
                      )}
                      ...
                      <div className="flex items-center justify-center min-w-14 z-10">
                        <item.icon
                          ...
                          className={cn(
                            ...
                            isActive
                              ? 'text-[#3b82f6] drop-shadow-[0_0_8px_rgba(255,161,22,0.4)]'
            ...
            >
              ...
              {isActive && (
                <motion.div
                  ...
                  className="absolute top-0 w-8 h-1 bg-[#3b82f6] rounded-b-full"
                />
              )}
