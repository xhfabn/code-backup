  ...
  return (
    ...
    >
      <div className="relative mb-8 group">
        <div className="absolute inset-0 bg-[#3b82f6]/20 blur-3xl rounded-full opacity-50 group-hover:opacity-80 transition-opacity duration-700" />
        <div className="relative w-32 h-32 bg-linear-to-br from-yellow-50 to-blue-50 rounded-[2.5rem] flex items-center justify-center shadow-inner border border-white/50">
          <Trophy
