  ...
  return (
    <div className="bg-white/60 backdrop-blur-xl p-8 rounded-[2rem] shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-white/60 h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {totalTasks > 0 && (
          <span className="text-xs font-bold bg-[#3b82f6]/10 text-[#3b82f6] px-3 py-1.5 rounded-full border border-[#3b82f6]/20">
        ...
        {hasTasks ? (
          ...
          <div className="flex flex-col gap-3 overflow-y-auto pr-2 -mr-2 scroll-smooth">
            {focusTasks.map((task) => (
              <div
                key={task.id}
                className="group relative p-5 bg-white rounded-2xl border border-gray-100/80 shadow-sm hover:shadow-md hover:border-[#3b82f6]/30 transition-all duration-300 shrink-0 cursor-pointer"
              >
                <div className="absolute left-0 top-4 bottom-4 w-1 bg-gray-100 rounded-r-full group-hover:bg-[#3b82f6] transition-colors duration-300" />
                ...
                <div className="pl-3">
                  ...
                  <div className="flex justify-between items-start gap-3">
                    <p className="font-bold text-gray-700 text-base leading-snug truncate flex-1 group-hover:text-[#3b82f6] transition-colors">
                      {task.title}
                    </p>
                    <span
