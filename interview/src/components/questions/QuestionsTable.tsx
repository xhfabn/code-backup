...
export const QuestionsTable = ({
  ...
  const renderSortIcon = (columnKey: SortConfig["key"]) => {
    ...
    return sortConfig.direction === "asc" ? (
      <ArrowUp size={14} className="ml-2 text-[#3b82f6]" />
    ) : (
      <ArrowDown size={14} className="ml-2 text-[#3b82f6]" />
    );
  };
                  ...
                  >
                    ...
                    <td className="p-4 min-w-[300px] max-w-[500px] wrap-break-word">
                      <span
                        ...
                        className="cursor-pointer font-semibold text-gray-700 group-hover:text-[#3b82f6] transition-colors text-base"
                      >
                        {row.problem.title}
                      </span>
                    </td>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2 bg-gray-100/50 p-1 rounded-xl border border-gray-100">
              ...
              <Button
                ...
                size="sm"
                onClick={handleJump}
                className="h-7 px-2 rounded-lg text-xs hover:bg-white hover:text-[#3b82f6] transition-all text-gray-500 font-bold cursor-pointer"
              >
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="rounded-xl border-gray-200 hover:bg-white hover:text-[#3b82f6] hover:border-[#3b82f6]/30 shadow-sm disabled:opacity-30 cursor-pointer transition-all"
              >
