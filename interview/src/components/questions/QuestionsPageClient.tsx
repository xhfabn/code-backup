          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="relative w-full sm:w-72 group">
              ...
              <Input
                ...
                className="pl-10 h-12 bg-white/80 backdrop-blur-md border-gray-200/60 shadow-sm rounded-2xl focus:ring-2 focus:ring-[#3b82f6]/20 focus:border-[#3b82f6]/50 transition-all text-base"
                value={searchQuery}
              ...
              <DialogTrigger asChild>
                <Button
                  ...
                  className={cn(
                    ...
                    activeFilterCount > 0 &&
                      'border-[#3b82f6]/30 text-[#3b82f6] bg-blue-50/50',
                  )}
                >
                  <Filter size={18} />
                  ...
                  {activeFilterCount > 0 && (
                    <span className="absolute -top-2 -right-2 w-5 h-5 bg-[#3b82f6] text-white text-[10px] font-bold flex items-center justify-center rounded-full shadow-sm ring-2 ring-white">
                      {activeFilterCount}
                    </span>
                  )}
                </Button>
            ...
            <Link href={'/questions/add'}>
              <Button className="h-12 px-6 bg-[#3b82f6] hover:bg-[#e69318] text-white flex-1 md:flex-none cursor-pointer rounded-2xl transition-all">
