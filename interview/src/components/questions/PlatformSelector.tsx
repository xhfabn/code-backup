            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center gap-4 p-6 rounded-2xl border-2 border-dashed border-gray-200 hover:border-[#3b82f6] hover:bg-blue-50/50 transition-all group cursor-pointer"
                >
            ...
            >
              ...
              <div className="space-y-4">
                <Input
                  ...
                  className="h-12 rounded-xl bg-white/50 border-gray-200 focus:border-[#3b82f6] focus:ring-[#3b82f6]/20"
                  autoFocus
                />
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    className="flex-1 h-11 rounded-xl bg-[#3b82f6] hover:bg-[#e69318] text-white"
                  >
                    {isLoading ? (
                      <>
