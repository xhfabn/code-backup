...
import { Code, FileText, Calendar, Edit3, BookOpen } from "lucide-react";
            ...
            <div className="p-8 md:p-12 space-y-12 w-full max-w-full">
              ...
              {data.problem.answer && (
                <div className="space-y-5 w-full overflow-hidden">
                  ...
                  <div className="p-8 rounded-[1.5rem] bg-gradient-to-br from-emerald-50/50 to-white border border-emerald-100 shadow-sm text-gray-700 min-h-[150px] w-full wrap-break-word">
                    <article
