      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-2 md:gap-4 h-auto md:h-16 px-2">
        <div className="flex items-center gap-3 w-full md:w-auto flex-1">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            {/* ID*/}
            <div className="hidden sm:flex items-center gap-1 shrink-0 bg-gray-100/50 hover:bg-gray-100 transition-colors px-3 py-1.5 rounded-xl border border-transparent focus-within:border-[#3b82f6]/30 focus-within:bg-white focus-within:shadow-sm">
        ...
        <div className="flex items-center gap-2 shrink-0 w-full md:w-auto justify-end pr-2">
          ...
          <Button
            className="bg-[#3b82f6] hover:bg-[#ff9000] text-white cursor-pointer rounded-xl px-6 h-11 shadow-lg shadow-blue-500/20 transition-all hover:scale-[1.02] active:scale-95 flex items-center gap-2"
            onClick={onSave}
            disabled={isSaving}
          >
            {isSaving ? (
